...
export const Route = createFileRoute("/tentang")({
  ...
  head: () => ({
    meta: [
      { title: "Tentang HMTI" },
      { name: "description", content: "Sejarah, visi, misi, dan struktur Himpunan Mahasiswa Teknik Informatika." },
...
const MILESTONES = [
  { year: "2015", title: "HMTI Didirikan", desc: "12 mahasiswa pendiri memulai organisasi dari sebuah lab komputer." },
  { year: "2018", title: "Hackathon Pertama", desc: "Menyelenggarakan kompetisi coding pertama dengan 80 peserta." },
  { year: "2020", title: "Transformasi Digital", desc: "Beradaptasi penuh ke event online, capai 5x lipat peserta nasional." },
  { year: "2023", title: "Mitra Industri 15+", desc: "Resmi bermitra dengan Gojek, Tokopedia, Telkom, dan lainnya." },
  { year: "2026", title: "Ekosistem IT Kampus", desc: "Menjadi pusat aktivitas IT mahasiswa dengan 500+ anggota aktif." },
];
...
const VALUES = [
  ...
  { icon: Sparkles, title: "Pertumbuhan", desc: "Belajar tanpa henti, individu maupun organisasi." },
];
...
function TentangPage() {
  return (
    <PageShell>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8 grid md:grid-cols-2 gap-8">
          <div className="rounded-xl border border-line bg-surface p-8">
            ...
            <p className="mt-4 text-bone-muted leading-relaxed">
              Menjadi organisasi mahasiswa Teknik Informatika terdepan yang melahirkan
              pemimpin teknologi berkarakter, inovatif, dan berdampak bagi Indonesia.
            </p>
          </div>
          <div className="rounded-xl border border-line bg-surface p-8">
            ...
            <ul className="mt-4 space-y-2 text-bone-muted">
              <li className="flex gap-3"><span className="text-red">▸</span> Mengembangkan kompetensi teknis dan soft skill anggota.</li>
              <li className="flex gap-3"><span className="text-red">▸</span> Membangun jembatan antara akademis dan industri.</li>
              <li className="flex gap-3"><span className="text-red">▸</span> Mendorong riset dan inovasi mahasiswa Informatika.</li>
              <li className="flex gap-3"><span className="text-red">▸</span> Menciptakan komunitas IT yang inklusif dan suportif.</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {MILESTONES.map((m, i) => (
                <div key={m.year} className={`relative grid md:grid-cols-2 gap-4 md:gap-12 ${i % 2 === 1 ? "md:[direction:rtl]" : ""}`}>
      ...
      <section className="py-20 bg-ink">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="font-mono text-xs uppercase tracking-widest text-red mb-3">Nilai-Nilai</div>
          <h2 className="font-display text-5xl text-bone mb-12">Yang Kami Pegang</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {VALUES.map((v) => (
              <div key={v.title} className="rounded-xl border border-line bg-surface p-6 card-hover">
