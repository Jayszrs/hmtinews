            ...
            {sent ? (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="mt-6 px-5 py-3 border border-line rounded-md font-heading text-xs uppercase tracking-widest text-bone hover:border-red hover:text-red"
                >
                  Kirim lagi
                </button>
              </div>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <Field label="Email">
                    <input type="email" required className="input" placeholder="email@kamu.com" />
                  </Field>
                </div>
                <Field label="Subjek">
                  <select className="input" defaultValue="">
                    ...
                    <option>Informasi Event</option>
                    <option>Gabung HMTI</option>
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-6 py-3 gradient-red text-bone rounded-md font-heading text-sm uppercase tracking-widest hover:shadow-red transition-shadow"
                >
            ...
            {[
              {
                Icon: MapPin,
                label: "Alamat",
                value: "Sekretariat HMTI, Gedung Informatika Lt. 2",
              },
              ...
              <div
                key={label}
                className="rounded-xl border border-line bg-surface p-5 flex gap-4 card-hover"
              >
                <span className="w-10 h-10 grid place-items-center rounded-md gradient-red shrink-0">
                  <Icon className="w-4 h-4 text-bone" />
                </span>
                <div>
