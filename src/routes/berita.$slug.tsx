    ...
    return (
      <div className="min-h-screen bg-hmti-dark text-white">
        ...
        <div className="mx-auto max-w-3xl px-5 py-40 text-center">
          <h1 className="font-display text-6xl">Berita tidak ditemukan</h1>
      ...
      <main className="pt-20">
        <section className="relative min-h-[62vh] overflow-hidden">
          ...
          <AnimatedSection className="relative mx-auto flex min-h-[62vh] max-w-5xl flex-col justify-end px-5 pb-16 lg:px-8">
            <span className="w-max rounded bg-hmti-gold px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-hmti-dark">
              {item.category}
            </span>
        ...
        <section className="mx-auto grid max-w-7xl gap-10 px-5 py-16 lg:grid-cols-[1fr_320px] lg:px-8">
          <article className="prose prose-invert max-w-none prose-headings:text-white prose-a:text-hmti-gold">
            <AnimatedSection>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md border border-white/10 px-3 py-2 text-sm text-white/70 hover:text-hmti-gold"
              >
              ...
              <div className="mt-4 space-y-3">
                {related.map((post) => (
                  <Link
                    ...
                    className="block text-sm text-white/70 hover:text-hmti-gold"
                  >
                    {post.title}
                  </Link>
                ))}
