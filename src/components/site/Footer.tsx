    ...
    <footer className="relative border-t border-red/30 bg-ink-soft mt-24">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="grid place-items-center w-9 h-9 rounded-md gradient-red">
          ...
          <p className="mt-4 text-sm text-bone-muted leading-relaxed">
            Himpunan Mahasiswa Teknik Informatika — pusat informasi, komunitas, dan ekosistem IT
            kampus.
          </p>
          <div className="mt-5 flex gap-2">
            {[Instagram, Linkedin, Twitter, Youtube, Github].map((Icon, i) => (
              <a
                ...
                href="#"
                aria-label="social"
                className="w-9 h-9 grid place-items-center rounded-md border border-line text-bone-muted hover:text-red hover:border-red hover:shadow-red transition-all"
              >
        ...
        <div>
          <h4 className="font-heading uppercase tracking-wider text-sm text-bone mb-4">
            Link Cepat
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-bone-muted">
            <li className="flex gap-2">
              <MapPin className="w-4 h-4 mt-0.5 text-red shrink-0" /> Sekretariat HMTI, Gedung
              Informatika Lt. 2
            </li>
            <li className="flex gap-2">
              <Mail className="w-4 h-4 mt-0.5 text-red shrink-0" /> halo@hmti.id
            </li>
            <li className="flex gap-2">
              <Phone className="w-4 h-4 mt-0.5 text-red shrink-0" /> +62 812 3456 7890
            </li>
            <li className="flex gap-2">
              <Clock className="w-4 h-4 mt-0.5 text-red shrink-0" /> Senin – Jumat, 09:00 – 17:00
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-bone-muted mb-4">
            Dapatkan update berita & event langsung di email kamu.
          </p>
      ...
      <div className="border-t border-line">
        <div className="mx-auto max-w-7xl px-5 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-bone-dim font-mono">
          ...
          <div>
            Made with <span className="text-red">❤</span> by HMTI Dev Team
          </div>
        </div>
      </div>
    </footer>
